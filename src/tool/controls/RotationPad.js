  ...
  constructor(container) {
    ...
    this.padElement.style.top =
      window.orientation === 0
        ? container.getBoundingClientRect().width - 150 + "px"
        : container.getBoundingClientRect().height - 200 + "px";
    ...
    if (window.orientation === 0) {
      let tempSet = this.regionData.offset.left;
      this.regionData.offset.left = this.regionData.offset.top;
      this.regionData.offset.top = tempSet;
    }
    ...
    if (distance > Math.pow(this.regionData.radius, 2)) {
      if (window.orientation === 0) {
        let angle = Math.atan2(
          this.regionData.centerY - newTop,
