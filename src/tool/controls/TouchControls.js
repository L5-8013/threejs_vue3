...
class TouchControls {
  ...
  constructor(container, camera, options, actor) {
    ...
    //   // color: 0xffeeff,three
    //   // side: THREE.DoubleSide,
    //   transparent: true,
    //   //   visible: false,
    // });
    // const cube2 = new THREE.Mesh(geometry1, material1);
    // cube2.position.set(this.actor.position);
    // //   model.position.set(20, -0.8, 10);
  ...
  #prepareRotationMatrices() {
    ...
    // console.log("init prepareRotationMatrices", this.#rotationMatrices);
  }
  ...
  update() {
    ...
    if (this.fpsBody.position.y >= 3) {
      this.fpsBody.position.y = 3;
    }
    if (this.fpsBody.position.y < 3) {
      this.fpsBody.position.y = 3;
    }
